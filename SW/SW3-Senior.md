...
| **Software design**     | {::nomarkdown}<ul><li>I am able to independently design software components in well scoped scenarios, with simplicity and maintenance as key considerations. My components are testable, debuggable and have logical APIs/Interfaces that are not easily misused.<br/><li>I know when to make significant refactors and when it’s better to leave things as-is.<br/><li>I have a strong grasp of the libraries, platforms, and systems that I rely on, allowing me to apply them expertly</li></ul>{:/} |
